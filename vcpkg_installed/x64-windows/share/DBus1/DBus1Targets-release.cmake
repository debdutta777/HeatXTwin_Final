...
set_target_properties(dbus-1 PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/dbus-1.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/dbus-1-3.dll"
  )

list(APPEND _cmake_import_check_targets dbus-1 )
list(APPEND _cmake_import_check_files_for_dbus-1 "${_IMPORT_PREFIX}/lib/dbus-1.lib" "${_IMPORT_PREFIX}/bin/dbus-1-3.dll" )
...
set_target_properties(dbus-daemon PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/dbus/dbus-daemon.exe"
  )
...
set_target_properties(dbus-send PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/dbus/dbus-send.exe"
  )
...
set_target_properties(dbus-test-tool PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/dbus/dbus-test-tool.exe"
  )
...
set_target_properties(dbus-update-activation-environment PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/dbus/dbus-update-activation-environment.exe"
  )
...
set_target_properties(dbus-launch PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/dbus/dbus-launch.exe"
  )
...
set_target_properties(dbus-monitor PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/dbus/dbus-monitor.exe"
  )
...
set_target_properties(dbus-run-session PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/dbus/dbus-run-session.exe"
  )

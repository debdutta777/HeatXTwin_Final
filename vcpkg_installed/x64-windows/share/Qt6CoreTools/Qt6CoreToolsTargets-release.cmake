...
set_target_properties(Qt6::syncqt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/syncqt.exe"
  )
...
set_target_properties(Qt6::moc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/moc.exe"
  )
...
set_target_properties(Qt6::rcc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/rcc.exe"
  )
...
set_target_properties(Qt6::tracepointgen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/tracepointgen.exe"
  )
...
set_target_properties(Qt6::tracegen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/tracegen.exe"
  )
...
set_target_properties(Qt6::cmake_automoc_parser PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/cmake_automoc_parser.exe"
  )
...
set_target_properties(Qt6::qlalr PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/qlalr.exe"
  )
...
set_target_properties(Qt6::qtpaths PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/qtpaths.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::qtpaths )
list(APPEND _cmake_import_check_files_for_Qt6::qtpaths "${_IMPORT_PREFIX}/tools/Qt6/bin/qtpaths.exe" )
...
set_target_properties(Qt6::androiddeployqt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/androiddeployqt.exe"
  )
...
set_target_properties(Qt6::androidtestrunner PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/androidtestrunner.exe"
  )
...
set_target_properties(Qt6::windeployqt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/windeployqt.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::windeployqt )
list(APPEND _cmake_import_check_files_for_Qt6::windeployqt "${_IMPORT_PREFIX}/tools/Qt6/bin/windeployqt.exe" )
...
set_target_properties(Qt6::qmake PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/Qt6/bin/qmake.exe"
  )

list(APPEND _cmake_import_check_targets Qt6::qmake )
list(APPEND _cmake_import_check_files_for_Qt6::qmake "${_IMPORT_PREFIX}/tools/Qt6/bin/qmake.exe" )
